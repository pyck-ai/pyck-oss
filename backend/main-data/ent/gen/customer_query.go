...
func (_q *CustomerQuery) prepareQuery(ctx context.Context) error {
	...
	if customer.Policy == nil {
		return errors.New("gen: uninitialized customer.Policy (forgotten import gen/runtime?)")
	}
	if err := customer.Policy.EvalQuery(ctx, _q); err != nil {
		return err
	}
	return nil
}
...
func (_q *CustomerQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Customer, error) {
	...
	_spec.Node.Schema = _q.schemaConfig.Customer
...
func (_q *CustomerQuery) sqlQuery(ctx context.Context) *sql.Selector {
	...
	t1.Schema(_q.schemaConfig.Customer)
	ctx = internal.NewSchemaConfigContext(ctx, _q.schemaConfig)
