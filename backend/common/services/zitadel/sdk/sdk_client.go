...
import (
	...
	zitadelsvc "github.com/pyck-ai/pyck/backend/common/services/zitadel"
)
...
func sdkOptions(ctx context.Context, issuer, apiURL, jwtProfilePath string, insecure bool) []zitadel.Option {
	if insecure {
		return []zitadel.Option{
			...
			zitadel.WithTokenSource(zitadelsvc.NewJWTProfileTokenSource(apiURL, issuer, jwtProfilePath)),
		}
	}
	return []zitadel.Option{
