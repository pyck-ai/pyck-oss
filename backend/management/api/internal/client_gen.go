...
func (t *GetTenants_Tenants_Edges_Node) GetExpiresAt() *time.Time {
	if t == nil {
		t = &GetTenants_Tenants_Edges_Node{}
	}
	return t.ExpiresAt
...
func (t *GetOrganization_Organization) GetActive() bool {
	if t == nil {
...
func (t *RegisterTenant_RegisterTenant_Tenant) GetCreatedAt() *time.Time {
	if t == nil {
		t = &RegisterTenant_RegisterTenant_Tenant{}
	}
	return &t.CreatedAt
}
func (t *RegisterTenant_RegisterTenant_Tenant) GetCreatedBy() *uuid.UUID {
	if t == nil {
		t = &RegisterTenant_RegisterTenant_Tenant{}
	}
	return &t.CreatedBy
}
func (t *RegisterTenant_RegisterTenant_Tenant) GetData() map[string]any {
	if t == nil {
		t = &RegisterTenant_RegisterTenant_Tenant{}
	}
	return t.Data
}
func (t *RegisterTenant_RegisterTenant_Tenant) GetDataTypeID() *uuid.UUID {
	if t == nil {
		t = &RegisterTenant_RegisterTenant_Tenant{}
	}
	return t.DataTypeID
}
func (t *RegisterTenant_RegisterTenant_Tenant) GetDataTypeSlug() *string {
	if t == nil {
		t = &RegisterTenant_RegisterTenant_Tenant{}
	}
	return t.DataTypeSlug
}
func (t *RegisterTenant_RegisterTenant_Tenant) GetDeletedAt() *time.Time {
	if t == nil {
		t = &RegisterTenant_RegisterTenant_Tenant{}
	}
	return t.DeletedAt
}
func (t *RegisterTenant_RegisterTenant_Tenant) GetDeletedBy() *uuid.UUID {
	if t == nil {
		t = &RegisterTenant_RegisterTenant_Tenant{}
	}
	return t.DeletedBy
}
func (t *RegisterTenant_RegisterTenant_Tenant) GetExpiresAt() *time.Time {
	if t == nil {
		t = &RegisterTenant_RegisterTenant_Tenant{}
	}
	return t.ExpiresAt
}
func (t *RegisterTenant_RegisterTenant_Tenant) GetID() string {
	if t == nil {
		t = &RegisterTenant_RegisterTenant_Tenant{}
	}
	return t.ID
}
func (t *RegisterTenant_RegisterTenant_Tenant) GetIdpOrgRef() string {
	if t == nil {
		t = &RegisterTenant_RegisterTenant_Tenant{}
	}
	return t.IdpOrgRef
}
func (t *RegisterTenant_RegisterTenant_Tenant) GetName() string {
	if t == nil {
		t = &RegisterTenant_RegisterTenant_Tenant{}
	}
	return t.Name
}
func (t *RegisterTenant_RegisterTenant_Tenant) GetUpdatedAt() *time.Time {
	if t == nil {
		t = &RegisterTenant_RegisterTenant_Tenant{}
	}
	return t.UpdatedAt
}
func (t *RegisterTenant_RegisterTenant_Tenant) GetUpdatedBy() *uuid.UUID {
	if t == nil {
		t = &RegisterTenant_RegisterTenant_Tenant{}
	}
	return t.UpdatedBy
...
type RegisterTenant_RegisterTenant struct {
	Success bool                                  "json:\"success\" graphql:\"success\""
	Tenant  *RegisterTenant_RegisterTenant_Tenant "json:\"tenant,omitempty\" graphql:\"tenant\""
}
...
func (t *RegisterTenant_RegisterTenant) GetTenant() *RegisterTenant_RegisterTenant_Tenant {
	if t == nil {
		t = &RegisterTenant_RegisterTenant{}
	}
	return t.Tenant
...
type DeleteTenant_DeleteTenant struct {
	Success bool "json:\"success\" graphql:\"success\""
}

func (t *DeleteTenant_DeleteTenant) GetSuccess() bool {
	if t == nil {
		t = &DeleteTenant_DeleteTenant{}
	}
	return t.Success
}

type RestoreTenant_RestoreTenant struct {
	Success bool "json:\"success\" graphql:\"success\""
}

func (t *RestoreTenant_RestoreTenant) GetSuccess() bool {
	if t == nil {
		t = &RestoreTenant_RestoreTenant{}
	}
	return t.Success
}

type SetTenantExpiry_SetTenantExpiry struct {
	Success bool "json:\"success\" graphql:\"success\""
}

func (t *SetTenantExpiry_SetTenantExpiry) GetSuccess() bool {
	if t == nil {
		t = &SetTenantExpiry_SetTenantExpiry{}
	}
	return t.Success
}
...
type DeleteTenant struct {
	DeleteTenant DeleteTenant_DeleteTenant "json:\"deleteTenant\" graphql:\"deleteTenant\""
}

func (t *DeleteTenant) GetDeleteTenant() *DeleteTenant_DeleteTenant {
	if t == nil {
		t = &DeleteTenant{}
	}
	return &t.DeleteTenant
}

type RestoreTenant struct {
	RestoreTenant RestoreTenant_RestoreTenant "json:\"restoreTenant\" graphql:\"restoreTenant\""
}

func (t *RestoreTenant) GetRestoreTenant() *RestoreTenant_RestoreTenant {
	if t == nil {
		t = &RestoreTenant{}
	}
	return &t.RestoreTenant
}

type SetTenantExpiry struct {
	SetTenantExpiry SetTenantExpiry_SetTenantExpiry "json:\"setTenantExpiry\" graphql:\"setTenantExpiry\""
}

func (t *SetTenantExpiry) GetSetTenantExpiry() *SetTenantExpiry_SetTenantExpiry {
	if t == nil {
		t = &SetTenantExpiry{}
	}
...
func (c *Client) GetOrganization(ctx context.Context, sub string, interceptors ...clientv2.RequestInterceptor) (*GetOrganization, error) {
	vars := map[string]any{
		"sub": sub,
	}
...
const DeleteTenantDocument = `mutation DeleteTenant {
	deleteTenant {
		success
	}
}
...
func (c *Client) DeleteTenant(ctx context.Context, interceptors ...clientv2.RequestInterceptor) (*DeleteTenant, error) {
	vars := map[string]any{}

	var res DeleteTenant
	if err := c.Client.Post(ctx, "DeleteTenant", DeleteTenantDocument, &res, vars, interceptors...); err != nil {
		if c.Client.ParseDataWhenErrors {
			return &res, err
		}
...
const RestoreTenantDocument = `mutation RestoreTenant ($input: RestoreTenantInput!) {
	restoreTenant(input: $input) {
		success
	}
}
`

func (c *Client) RestoreTenant(ctx context.Context, input model.RestoreTenantInput, interceptors ...clientv2.RequestInterceptor) (*RestoreTenant, error) {
	vars := map[string]any{
		"input": input,
	}

	var res RestoreTenant
	if err := c.Client.Post(ctx, "RestoreTenant", RestoreTenantDocument, &res, vars, interceptors...); err != nil {
		if c.Client.ParseDataWhenErrors {
			return &res, err
		}
...
const SetTenantExpiryDocument = `mutation SetTenantExpiry ($input: SetTenantExpiryInput!) {
	setTenantExpiry(input: $input) {
		success
	}
}
`

func (c *Client) SetTenantExpiry(ctx context.Context, input model.SetTenantExpiryInput, interceptors ...clientv2.RequestInterceptor) (*SetTenantExpiry, error) {
	vars := map[string]any{
		"input": input,
	}

	var res SetTenantExpiry
	if err := c.Client.Post(ctx, "SetTenantExpiry", SetTenantExpiryDocument, &res, vars, interceptors...); err != nil {
		if c.Client.ParseDataWhenErrors {
			return &res, err
		}
