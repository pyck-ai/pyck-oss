...
var devicelocationImplementors = []string{"DeviceLocation", "Node"}

// IsNode implements the Node interface check for GQLGen.
func (*DeviceLocation) IsNode() {}

var deviceuserImplementors = []string{"DeviceUser", "Node"}

// IsNode implements the Node interface check for GQLGen.
func (*DeviceUser) IsNode() {}
...
func (c *Client) noder(ctx context.Context, table string, id uuid.UUID) (Noder, error) {
	...
	case datatype.Table:
		...
		if fc := graphql.GetFieldContext(ctx); fc != nil {
			if err := query.collectField(ctx, true, graphql.GetOperationContext(ctx), fc.Field, nil, datatypeImplementors...); err != nil {
				return nil, err
			}
		}
	...
	case device.Table:
		...
		return query.Only(ctx)
	case devicelocation.Table:
		query := c.DeviceLocation.Query().
			Where(devicelocation.ID(id))
		if fc := graphql.GetFieldContext(ctx); fc != nil {
			if err := query.collectField(ctx, true, graphql.GetOperationContext(ctx), fc.Field, nil, devicelocationImplementors...); err != nil {
				return nil, err
			}
		}
		return query.Only(ctx)
	case deviceuser.Table:
		query := c.DeviceUser.Query().
			Where(deviceuser.ID(id))
		if fc := graphql.GetFieldContext(ctx); fc != nil {
			if err := query.collectField(ctx, true, graphql.GetOperationContext(ctx), fc.Field, nil, deviceuserImplementors...); err != nil {
				return nil, err
			}
		}
		return query.Only(ctx)
	...
	case keyvalue.Table:
		...
		if fc := graphql.GetFieldContext(ctx); fc != nil {
			if err := query.collectField(ctx, true, graphql.GetOperationContext(ctx), fc.Field, nil, keyvalueImplementors...); err != nil {
				return nil, err
			}
		}
		return query.Only(ctx)
...
func (c *Client) noders(ctx context.Context, table string, ids []uuid.UUID) ([]Noder, error) {
	...
	case datatype.Table:
		...
		query, err := query.CollectFields(ctx, datatypeImplementors...)
		if err != nil {
			return nil, err
		}
	...
	case devicelocation.Table:
		query := c.DeviceLocation.Query().
			Where(devicelocation.IDIn(ids...))
		query, err := query.CollectFields(ctx, devicelocationImplementors...)
		if err != nil {
			return nil, err
		}
		nodes, err := query.All(ctx)
	...
	case deviceuser.Table:
		query := c.DeviceUser.Query().
			Where(deviceuser.IDIn(ids...))
		query, err := query.CollectFields(ctx, deviceuserImplementors...)
		if err != nil {
			return nil, err
		}
		nodes, err := query.All(ctx)
	...
	case keyvalue.Table:
		...
		query, err := query.CollectFields(ctx, keyvalueImplementors...)
		if err != nil {
			return nil, err
		}
		nodes, err := query.All(ctx)
