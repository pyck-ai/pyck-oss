...
func (f DataTypeFunc) Mutate(ctx context.Context, m gen.Mutation) (gen.Value, error) {
	if mv, ok := m.(*gen.DataTypeMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *gen.DataTypeMutation", m)
}
...
// The DeviceLocationFunc type is an adapter to allow the use of ordinary
// function as DeviceLocation mutator.
type DeviceLocationFunc func(context.Context, *gen.DeviceLocationMutation) (gen.Value, error)

// Mutate calls f(ctx, m).
func (f DeviceLocationFunc) Mutate(ctx context.Context, m gen.Mutation) (gen.Value, error) {
	if mv, ok := m.(*gen.DeviceLocationMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *gen.DeviceLocationMutation", m)
}

// The DeviceUserFunc type is an adapter to allow the use of ordinary
// function as DeviceUser mutator.
type DeviceUserFunc func(context.Context, *gen.DeviceUserMutation) (gen.Value, error)

// Mutate calls f(ctx, m).
func (f DeviceUserFunc) Mutate(ctx context.Context, m gen.Mutation) (gen.Value, error) {
	if mv, ok := m.(*gen.DeviceUserMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *gen.DeviceUserMutation", m)
}
...
type EventFunc func(context.Context, *gen.EventMutation) (gen.Value, error)

// Mutate calls f(ctx, m).
func (f EventFunc) Mutate(ctx context.Context, m gen.Mutation) (gen.Value, error) {
	if mv, ok := m.(*gen.EventMutation); ok {
		return f(ctx, mv)
	}
...
// Mutate calls f(ctx, m).
func (f KeyValueFunc) Mutate(ctx context.Context, m gen.Mutation) (gen.Value, error) {
	if mv, ok := m.(*gen.KeyValueMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *gen.KeyValueMutation", m)
}

// The LocationFunc type is an adapter to allow the use of ordinary
// function as Location mutator.
type LocationFunc func(context.Context, *gen.LocationMutation) (gen.Value, error)

// Mutate calls f(ctx, m).
func (f LocationFunc) Mutate(ctx context.Context, m gen.Mutation) (gen.Value, error) {
	if mv, ok := m.(*gen.LocationMutation); ok {
		return f(ctx, mv)
	}
