...
// QueryDeviceLocationsDevice chains the current query on the "deviceLocationsDevice" edge.
func (_q *DeviceQuery) QueryDeviceLocationsDevice() *DeviceLocationQuery {
...
// QueryDeviceUsersDevice chains the current query on the "deviceUsersDevice" edge.
func (_q *DeviceQuery) QueryDeviceUsersDevice() *DeviceUserQuery {
...
func (_q *DeviceQuery) Clone() *DeviceQuery {
	...
	return &DeviceQuery{
		...
		withDeviceLocationsDevice: _q.withDeviceLocationsDevice.Clone(),
		withDeviceUsersDevice:     _q.withDeviceUsersDevice.Clone(),
...
// WithDeviceLocationsDevice tells the query-builder to eager-load the nodes that are connected to
// the "deviceLocationsDevice" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *DeviceQuery) WithDeviceLocationsDevice(opts ...func(*DeviceLocationQuery)) *DeviceQuery {
	query := (&DeviceLocationClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withDeviceLocationsDevice = query
	return _q
}

// WithDeviceUsersDevice tells the query-builder to eager-load the nodes that are connected to
// the "deviceUsersDevice" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *DeviceQuery) WithDeviceUsersDevice(opts ...func(*DeviceUserQuery)) *DeviceQuery {
	query := (&DeviceUserClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withDeviceUsersDevice = query
	return _q
}
...
func (_q *DeviceQuery) prepareQuery(ctx context.Context) error {
	...
	if device.Policy == nil {
		return errors.New("gen: uninitialized device.Policy (forgotten import gen/runtime?)")
	}
	if err := device.Policy.EvalQuery(ctx, _q); err != nil {
		return err
	}
	return nil
}
...
func (_q *DeviceQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Device, error) {
	var (
		...
		_spec       = _q.querySpec()
		loadedTypes = [2]bool{
			_q.withDeviceLocationsDevice != nil,
			_q.withDeviceUsersDevice != nil,
		}
	)
	...
	_spec.Node.Schema = _q.schemaConfig.Device
	...
	if query := _q.withDeviceLocationsDevice; query != nil {
		if err := _q.loadDeviceLocationsDevice(ctx, query, nodes,
			func(n *Device) { n.Edges.DeviceLocationsDevice = []*DeviceLocation{} },
			func(n *Device, e *DeviceLocation) {
				n.Edges.DeviceLocationsDevice = append(n.Edges.DeviceLocationsDevice, e)
			}); err != nil {
			return nil, err
		}
	}
	if query := _q.withDeviceUsersDevice; query != nil {
		if err := _q.loadDeviceUsersDevice(ctx, query, nodes,
			func(n *Device) { n.Edges.DeviceUsersDevice = []*DeviceUser{} },
			func(n *Device, e *DeviceUser) { n.Edges.DeviceUsersDevice = append(n.Edges.DeviceUsersDevice, e) }); err != nil {
			return nil, err
		}
	}
	for name, query := range _q.withNamedDeviceLocationsDevice {
		if err := _q.loadDeviceLocationsDevice(ctx, query, nodes,
			func(n *Device) { n.appendNamedDeviceLocationsDevice(name) },
			func(n *Device, e *DeviceLocation) { n.appendNamedDeviceLocationsDevice(name, e) }); err != nil {
			return nil, err
		}
	}
	for name, query := range _q.withNamedDeviceUsersDevice {
		if err := _q.loadDeviceUsersDevice(ctx, query, nodes,
			func(n *Device) { n.appendNamedDeviceUsersDevice(name) },
			func(n *Device, e *DeviceUser) { n.appendNamedDeviceUsersDevice(name, e) }); err != nil {
			return nil, err
		}
	}
...
func (_q *DeviceQuery) loadDeviceLocationsDevice(ctx context.Context, query *DeviceLocationQuery, nodes []*Device, init func(*Device), assign func(*Device, *DeviceLocation)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(devicelocation.FieldDeviceID)
	}
	query.Where(predicate.DeviceLocation(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(device.DeviceLocationsDeviceColumn), fks...))
	}))
...
func (_q *DeviceQuery) loadDeviceUsersDevice(ctx context.Context, query *DeviceUserQuery, nodes []*Device, init func(*Device), assign func(*Device, *DeviceUser)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*Device)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(deviceuser.FieldDeviceID)
	}
	query.Where(predicate.DeviceUser(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(device.DeviceUsersDeviceColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *DeviceQuery) WithNamedDeviceLocationsDevice(name string, opts ...func(*DeviceLocationQuery)) *DeviceQuery {
	query := (&DeviceLocationClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	if _q.withNamedDeviceLocationsDevice == nil {
		_q.withNamedDeviceLocationsDevice = make(map[string]*DeviceLocationQuery)
	}
	_q.withNamedDeviceLocationsDevice[name] = query
	return _q
}

// WithNamedDeviceUsersDevice tells the query-builder to eager-load the nodes that are connected to the "deviceUsersDevice"
// edge with the given name. The optional arguments are used to configure the query builder of the edge.
func (_q *DeviceQuery) WithNamedDeviceUsersDevice(name string, opts ...func(*DeviceUserQuery)) *DeviceQuery {
	query := (&DeviceUserClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	if _q.withNamedDeviceUsersDevice == nil {
		_q.withNamedDeviceUsersDevice = make(map[string]*DeviceUserQuery)
	}
	_q.withNamedDeviceUsersDevice[name] = query
	return _q
}
