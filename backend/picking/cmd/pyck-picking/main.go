...
import (
	...
	_ "github.com/pyck-ai/pyck/backend/picking/ent/gen/runtime"
	entmigrate "github.com/pyck-ai/pyck/backend/picking/ent/migrate"
...
func main() {
	...
	gqlHandler.Use(
		...
		gate.HTTPMiddleware(serviceroles.Picking),
	...
	httpRouter.Handle("/health", handlers.NewHealthCheckHandler(db.NewDbHealthChecker(pgxDriver.DB(), entorder.Table)))
