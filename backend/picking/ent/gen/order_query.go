...
type OrderQuery struct {
	...
	withOutboundShipmentNotifications      *OutboundShipmentNotificationQuery
	loadTotal                              []func(context.Context, []*Order) error
	modifiers                              []func(*sql.Selector)
	withNamedOrderItems                    map[string]*OrderItemsQuery
	withNamedOutboundShipmentNotifications map[string]*OutboundShipmentNotificationQuery
...
// QueryOrderItems chains the current query on the "orderItems" edge.
func (_q *OrderQuery) QueryOrderItems() *OrderItemsQuery {
...
// QueryOutboundShipmentNotifications chains the current query on the "outboundShipmentNotifications" edge.
func (_q *OrderQuery) QueryOutboundShipmentNotifications() *OutboundShipmentNotificationQuery {
...
func (_q *OrderQuery) Clone() *OrderQuery {
	...
	return &OrderQuery{
		...
		withOutboundShipmentNotifications: _q.withOutboundShipmentNotifications.Clone(),
...
// the "orderItems" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *OrderQuery) WithOrderItems(opts ...func(*OrderItemsQuery)) *OrderQuery {
	query := (&OrderItemsClient{config: _q.config}).Query()
...
// WithOutboundShipmentNotifications tells the query-builder to eager-load the nodes that are connected to
// the "outboundShipmentNotifications" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *OrderQuery) WithOutboundShipmentNotifications(opts ...func(*OutboundShipmentNotificationQuery)) *OrderQuery {
	query := (&OutboundShipmentNotificationClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withOutboundShipmentNotifications = query
	return _q
}
...
func (_q *OrderQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Order, error) {
	var (
		...
		loadedTypes = [2]bool{
			...
			_q.withOutboundShipmentNotifications != nil,
		}
	)
	...
	_spec.Node.Schema = _q.schemaConfig.Order
	...
	if query := _q.withOrderItems; query != nil {
		if err := _q.loadOrderItems(ctx, query, nodes,
			func(n *Order) { n.Edges.OrderItems = []*OrderItems{} },
			func(n *Order, e *OrderItems) { n.Edges.OrderItems = append(n.Edges.OrderItems, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withOutboundShipmentNotifications; query != nil {
		if err := _q.loadOutboundShipmentNotifications(ctx, query, nodes,
			func(n *Order) { n.Edges.OutboundShipmentNotifications = []*OutboundShipmentNotification{} },
			func(n *Order, e *OutboundShipmentNotification) {
				n.Edges.OutboundShipmentNotifications = append(n.Edges.OutboundShipmentNotifications, e)
			}); err != nil {
			return nil, err
		}
	}
	for name, query := range _q.withNamedOrderItems {
		if err := _q.loadOrderItems(ctx, query, nodes,
			func(n *Order) { n.appendNamedOrderItems(name) },
			func(n *Order, e *OrderItems) { n.appendNamedOrderItems(name, e) }); err != nil {
			return nil, err
		}
	}
	for name, query := range _q.withNamedOutboundShipmentNotifications {
		if err := _q.loadOutboundShipmentNotifications(ctx, query, nodes,
			func(n *Order) { n.appendNamedOutboundShipmentNotifications(name) },
			func(n *Order, e *OutboundShipmentNotification) { n.appendNamedOutboundShipmentNotifications(name, e) }); err != nil {
			return nil, err
		}
	}
...
func (_q *OrderQuery) loadOrderItems(ctx context.Context, query *OrderItemsQuery, nodes []*Order, init func(*Order), assign func(*Order, *OrderItems)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(orderitems.FieldOrderID)
	}
...
func (_q *OrderQuery) loadOutboundShipmentNotifications(ctx context.Context, query *OutboundShipmentNotificationQuery, nodes []*Order, init func(*Order), assign func(*Order, *OutboundShipmentNotification)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*Order)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(outboundshipmentnotification.FieldOrderID)
	}
	query.Where(predicate.OutboundShipmentNotification(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(order.OutboundShipmentNotificationsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *OrderQuery) sqlQuery(ctx context.Context) *sql.Selector {
	...
	t1.Schema(_q.schemaConfig.Order)
	ctx = internal.NewSchemaConfigContext(ctx, _q.schemaConfig)
...
// WithNamedOrderItems tells the query-builder to eager-load the nodes that are connected to the "orderItems"
// edge with the given name. The optional arguments are used to configure the query builder of the edge.
func (_q *OrderQuery) WithNamedOrderItems(name string, opts ...func(*OrderItemsQuery)) *OrderQuery {
	query := (&OrderItemsClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	if _q.withNamedOrderItems == nil {
		_q.withNamedOrderItems = make(map[string]*OrderItemsQuery)
	}
	_q.withNamedOrderItems[name] = query
	return _q
}

// WithNamedOutboundShipmentNotifications tells the query-builder to eager-load the nodes that are connected to the "outboundShipmentNotifications"
// edge with the given name. The optional arguments are used to configure the query builder of the edge.
func (_q *OrderQuery) WithNamedOutboundShipmentNotifications(name string, opts ...func(*OutboundShipmentNotificationQuery)) *OrderQuery {
	query := (&OutboundShipmentNotificationClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	if _q.withNamedOutboundShipmentNotifications == nil {
		_q.withNamedOutboundShipmentNotifications = make(map[string]*OutboundShipmentNotificationQuery)
	}
	_q.withNamedOutboundShipmentNotifications[name] = query
	return _q
}
