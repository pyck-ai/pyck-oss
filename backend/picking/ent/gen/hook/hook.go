...
// The OrderItemsFunc type is an adapter to allow the use of ordinary
// function as OrderItems mutator.
type OrderItemsFunc func(context.Context, *gen.OrderItemsMutation) (gen.Value, error)

// Mutate calls f(ctx, m).
func (f OrderItemsFunc) Mutate(ctx context.Context, m gen.Mutation) (gen.Value, error) {
	if mv, ok := m.(*gen.OrderItemsMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *gen.OrderItemsMutation", m)
}

// The OutboundShipmentNotificationFunc type is an adapter to allow the use of ordinary
// function as OutboundShipmentNotification mutator.
type OutboundShipmentNotificationFunc func(context.Context, *gen.OutboundShipmentNotificationMutation) (gen.Value, error)

// Mutate calls f(ctx, m).
func (f OutboundShipmentNotificationFunc) Mutate(ctx context.Context, m gen.Mutation) (gen.Value, error) {
	if mv, ok := m.(*gen.OutboundShipmentNotificationMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *gen.OutboundShipmentNotificationMutation", m)
}
