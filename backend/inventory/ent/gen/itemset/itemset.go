...
const (
	// Label holds the string label denoting the itemset type in the database.
	Label = "item_set"
	...
	EdgeItems = "items"
	// Table holds the table name of the itemset in the database.
	Table = "item_sets"
	// ItemsTable is the table that holds the items relation/edge. The primary key declared below.
	ItemsTable = "item_set_items"
	// ItemsInverseTable is the table name for the Item entity.
	// It exists in this package in order to avoid circular dependency with the "item" package.
	ItemsInverseTable = "items"
)

// Columns holds all SQL columns for itemset fields.
var Columns = []string{
	FieldID,
	FieldTenantID,
	FieldDataTypeID,
...
var (
	...
	ItemsPrimaryKey = []string{"item_set_id", "item_id"}
)
...
// OrderOption defines the ordering options for the ItemSet queries.
