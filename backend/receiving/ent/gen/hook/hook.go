...
func (f InboundFunc) Mutate(ctx context.Context, m gen.Mutation) (gen.Value, error) {
	if mv, ok := m.(*gen.InboundMutation); ok {
		return f(ctx, mv)
	}
...
func (f InboundItemFunc) Mutate(ctx context.Context, m gen.Mutation) (gen.Value, error) {
	if mv, ok := m.(*gen.InboundItemMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *gen.InboundItemMutation", m)
}

// The InboundShipmentNotificationFunc type is an adapter to allow the use of ordinary
// function as InboundShipmentNotification mutator.
type InboundShipmentNotificationFunc func(context.Context, *gen.InboundShipmentNotificationMutation) (gen.Value, error)

// Mutate calls f(ctx, m).
func (f InboundShipmentNotificationFunc) Mutate(ctx context.Context, m gen.Mutation) (gen.Value, error) {
	if mv, ok := m.(*gen.InboundShipmentNotificationMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *gen.InboundShipmentNotificationMutation", m)
}
